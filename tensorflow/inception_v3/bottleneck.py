...
#mnist_write_img('./train', mnist.train.num_examples, mnist.train.images, mnist.train.labels)
...
train_generator = train_datagen.flow_from_directory('./train', target_size=(150,150), batch_size=50)

model.fit_generator(train_generator, steps_per_epoch=1100, epochs=5)
